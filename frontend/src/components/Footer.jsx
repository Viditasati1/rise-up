...
const Footer = () => {
  return (
    <footer className="bg-[#2D1B68]  text-white py-10">
      <div className="container mx-auto px-6 sm:px-12 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex flex-wrap justify-center md:justify-start gap-6">
          <a href="#about" className="text-gray-300 hover:text-[#10B981] transition-colors duration-300">
            About Us
          </a>
          <a href="#services" className="text-gray-300 hover:text-[#10B981] transition-colors duration-300">
            Services
          </a>
          <a href="#contact" className="text-gray-300 hover:text-[#10B981] transition-colors duration-300">
            Contact
          </a>
          <a href="#faq" className="text-gray-300 hover:text-[#10B981] transition-colors duration-300">
            FAQ
          </a>
        </div>
